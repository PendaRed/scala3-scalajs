...
function $s_Lcom_jgibbons_eg1_Hello__main__AT__V(args) {
  try {
    $m_Lcom_jgibbons_eg1_Hello$package$().Hello__V()
  } catch (e) {
    if (false) {
...
/** @constructor */
function $c_Lcom_jgibbons_eg1_Hello$package$() {
  /*<skip>*/
}
$c_Lcom_jgibbons_eg1_Hello$package$.prototype = new $h_O();
$c_Lcom_jgibbons_eg1_Hello$package$.prototype.constructor = $c_Lcom_jgibbons_eg1_Hello$package$;
/** @constructor */
function $h_Lcom_jgibbons_eg1_Hello$package$() {
  /*<skip>*/
}
$h_Lcom_jgibbons_eg1_Hello$package$.prototype = $c_Lcom_jgibbons_eg1_Hello$package$.prototype;
$c_Lcom_jgibbons_eg1_Hello$package$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode)
});
$c_Lcom_jgibbons_eg1_Hello$package$.prototype.Hello__V = (function() {
  $m_Lcom_jgibbons_eg1_Hello$package$().appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Hello World again")
});
var $d_Lcom_jgibbons_eg1_Hello$package$ = new $TypeData().initClass({
  Lcom_jgibbons_eg1_Hello$package$: 0
}, false, "com.jgibbons.eg1.Hello$package$", {
  Lcom_jgibbons_eg1_Hello$package$: 1,
  O: 1
});
$c_Lcom_jgibbons_eg1_Hello$package$.prototype.$classData = $d_Lcom_jgibbons_eg1_Hello$package$;
var $n_Lcom_jgibbons_eg1_Hello$package$;
function $m_Lcom_jgibbons_eg1_Hello$package$() {
  if ((!$n_Lcom_jgibbons_eg1_Hello$package$)) {
    $n_Lcom_jgibbons_eg1_Hello$package$ = new $c_Lcom_jgibbons_eg1_Hello$package$()
  };
  return $n_Lcom_jgibbons_eg1_Hello$package$
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lcom_jgibbons_eg1_Hello__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
