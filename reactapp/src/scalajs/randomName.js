...
function $p_Lnamegen_RandomNameGenerator$__rndInt__I__I($thiz, max) {
  return $doubleToInt(($thiz.Lnamegen_RandomNameGenerator$__f_rnd.nextDouble__D() * max))
}
function $p_Lnamegen_RandomNameGenerator$__str__sci_List__T($thiz, s) {
  ...
  return $as_T($f_sc_LinearSeqOps__apply__I__O(s, n))
}
/** @constructor */
function $c_Lnamegen_RandomNameGenerator$() {
  ...
  $m_s_package$();
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T.getArrayOf().constr)(["jon", "ton", "sar", "fly", "tom", "geo", "hen", "emi", "ali", "ell", "greg"]));
  this.Lnamegen_RandomNameGenerator$__f_first = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems);
  $m_s_package$();
  var elems$1 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T.getArrayOf().constr)(["at", "ist", "or"]));
  this.Lnamegen_RandomNameGenerator$__f_mid = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems$1);
  $m_s_package$();
  var elems$2 = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_T.getArrayOf().constr)(["hon", "y", "ah", "nne", "as", "rge", "ry", "ly", "air", "iot", "y"]));
  this.Lnamegen_RandomNameGenerator$__f_last = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems$2);
  this.Lnamegen_RandomNameGenerator$__f_rnd = new $c_ju_Random(new $c_RTLong(10, 0))
}
$c_Lnamegen_RandomNameGenerator$.prototype = new $h_O();
...
var $d_Lnamegen_RandomNameGenerator$ = new $TypeData().initClass({
